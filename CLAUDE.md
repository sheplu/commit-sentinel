...
`quality-gates.yaml` runs on PRs to main: OSV scan, semgrep, npm audit, lint, typecheck, build + package size check, 5 test categories with coverage artifacts, merged coverage PR comment, typedoc build.
